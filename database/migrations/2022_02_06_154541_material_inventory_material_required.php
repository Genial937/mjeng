...
class MaterialInventoryMaterialRequired extends Migration
{
    ...
    public function up()
    {
        Schema::create('material_inventory_material_required', function (Blueprint $table) {
            ...
            $table->foreign('material_inventory_id',"m_inv_id")->references('id')->on('material_inventory')
                ->onUpdate('cascade')->onDelete('cascade');
            $table->integer('material_required_id')->unsigned();
            $table->foreign('material_required_id',"m_re_id")->references('id')->on('materials_required')
                ->onUpdate('cascade')->onDelete('cascade');
        });
    }
