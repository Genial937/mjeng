<?php
    ...
    class TransactionsController extends Controller
    {
        ...
        public function index(Request $request){
            ...
            $payments=Transaction::with(["outletcardfloathistory","outletfloathistory"])
        ...
        public function fees(Request $request){
            ...
            $transactions=Transaction::with(["outletcardfloathistory","outletfloathistory"])
                ...
                ->get();
            $fees =Transaction::orderBy('created_at', 'DESC')
                ->where(
                    function ($query) {
                        $query->where('type', 1)
                            ->orWhere('type', 4);
                    })->whereBetween('created_at', [$start_date . " 00:00:00", $end_date . ' 23:59:59'])->sum("fees");
            return view('Transactions.fees',compact("transactions","fees"));
        }
    }
