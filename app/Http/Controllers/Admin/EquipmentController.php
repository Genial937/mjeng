...
class EquipmentController extends Controller
{
    ...
    public function index(Request  $request)
    {
        ...
        return view('admin.v1.inventory.equipment.index',compact("equipments","businesses"));
    }
    ...
    public function showCreateView()
    {
        ...
        return view('admin.v1.inventory.equipment.create',compact("equipments","equipment_types","businesses"));
    }
    /**
     * Show the form for creating a new resource.
     *
    ...
    public function showEditView(Request $request)
    {
        ...
        return view('admin.v1.inventory.equipment.edit',compact("equipment","equipment_types","businesses",'equipment_models'));
    }
    /**
