                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($equipment->status==0)
                                                            ...
                                                            <label class="badge badge-success">Ready to Work/Approved</label>
                                                            @elseif($equipment->status==2)
                                                            <label class="badge badge-warning">Engage Externally</label>
                                                             @elseif($equipment->status==3)
                                                            <label class="badge badge-danger">Approval Withheld</label>
                                                             ...
                                                             <label class="badge badge-danger">Engage</label>
                                                              @elseif($equipment->status==8)
                                                              <label class="badge badge-danger">Suspended</label>
                                                              @elseif($equipment->status==9)
                                                              <label class="badge badge-danger">Approval declined -application deleted after 2days</label>
                                                             @endif
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="{{route("admin.inventory.edit.equipment",$equipment->id)}}" class="dropdown-item">Update </a>
                                                                <a href="#" class="dropdown-item" onclick="deleteRecord('{{route("admin.delete.equipment",$equipment->id)}}')">Delete</a>
