    ...
    <div class="col-md-10 offset-1 text-left">
        <nav>
            <ol class="cd-breadcrumb triangle">
                ...
                <li><a href="#" class="btn {{ Request::is('admin/projects/form/create/material/*') ? 'btn-gradient-success' : ' btn-gradient-warning'}} btn-uppercase btn-lg text-white">4. Material Required</a></li>
            </ol>
        </nav>
    </div>
</div>
