...
<head>
    ...
    <style type="text/css">
        ...
        td .es-button-border-1:hover {
            border-color: #30d3c3 #30d3c3 #30d3c3 #30d3c3 !important;
            background: #ffffff !important;
        }
                                                    ...
                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left top"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <img
                                                                    src="https://merchant.pokeapay.com/assets/images/email/secure.png"
                                                                    alt
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;line-height:24px;color:#666666;">
                                                                    Enter this 6 digit verification code on the registration page to verify
                                                                    your account. </p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <span class="es-button-border es-button-border-1"
                                                                      style="border-style:solid;border-color:#25AD9F;background:#FFFFFF;border-width:2px;display:inline-block;border-radius:10px;width:auto"><code style="font-size:25px; color:#25AD9F"> {{$data['code']}}</code></span>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-top:25px;padding-left:40px;padding-right:40px; padding-bottom: 40px;">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;"> If did not make this request, just ignore this email.</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
