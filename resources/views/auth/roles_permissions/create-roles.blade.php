...
@section('content')
    ...
    <div class="main-panel">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <form id="create-role" method="POST" action="{{route("create-role")}}" >
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
        ...
        <script type="text/javascript">
            ...
            $( document ).on('submit','#create-role',function(e) {
                e.preventDefault();
                $('.btn-submit').text('');
                $('.btn-submit').append('<div class="circle"></div>');
                var url=$('#create-role').attr('action');
                $.post( url, $("#create-role" ).serialize())
                    .done(function( data ) {
                        console.log(data)
                        if (data['success']) {
