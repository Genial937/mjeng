...
@section('content')
                        ...
                        <div class="col-xl-10 offset-1">
                            <div class="content-title mt-0">
                                ...
                                <div class="text-right">
                                    <a href="{{route("vendor.create.user")}}" class="btn btn-primary btn-uppercase btn-link text-white">Create a User</a>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($user->status==2)
                                                        <label class="badge badge-warning">Pending Email Verification</label>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="javascript:void(0)" onclick="viewUserModal('{{json_encode($user)}}')" class="dropdown-item">View Details</a>
                                                            <a href="{{route("vendor.edit.user",$user->id)}}" class="dropdown-item">Update</a>
                                                            <a href="#" class="dropdown-item" onclick="deleteRecord('{{route("vendor.user.delete",$user->id)}}')">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    @include("vendor.v1.users.modals.view-user")
    <!-- App scripts -->
