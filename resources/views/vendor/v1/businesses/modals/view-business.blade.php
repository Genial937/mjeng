<div class="modal fade" id="view-business" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-md-8 offset-2">
                        <h5 class="modal-title">
                            ...
                            Business Detail</h5>
                        <hr>
                        <h5 class="margin-5-p">Business : <span class="modal-business-name text-danger font-italic"></span></h5>
                        <h5 class="margin-5-p">Email : <span class="modal-business-email text-danger font-italic"></span></h5>
                        ...
                        <h5 class="modal-title">
                            ...
                            Business Documents</h5>
                        <hr>
                        <div class="modal-business-documents">
