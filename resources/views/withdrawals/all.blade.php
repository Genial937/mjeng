...
{{--                                                        <option value="WALLET">WALLET</option>--}}
                ...
                @ability('admin', 'view-withdrawals')
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
...
{{--                                    User</a>--}}
                                <h5>Withdrawals ({{count($withdrawals)}})</h5>
                            </div>
                            <div class="card-content">
                                <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                    ...
                                    <th data-field="amount" data-sortable="true">Fees</th>
                                    ...
                                    @if($withdrawals)
                                        @foreach($withdrawals as $withdrawal)
                                            <tr>
                                                ...
                                                <td>{{$withdrawal->description??"_"}}</td>
                                                <td>{{$withdrawal->receipt??"_"}}</td>
                                                <td>{{$withdrawal->amount??"_"}}</td>
                                                <td>{{$withdrawal->fees??"_"}}</td>
                                                <td>{{$withdrawal->method??"_"}}</td>
                                                <td>@if($withdrawal->status==1)<label class="label label-success">SUCCESS</label>@else <label class="label label-warning">PENDING</label> @endif</td>
                                                <td><a href="{{route("members-edit-view",$withdrawal->user->id)}}">{{$withdrawal->user->referral_code??"_"}}</a></td>
                                                <td>
                                                    <div class="dropup">
